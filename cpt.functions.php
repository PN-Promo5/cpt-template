...
//  WARNING : AVANT CE CODE SE TROUVE LES FONCTIONS QUI FONT APPEL AU THÈME PARENT
// WARNING : NE PAS LES SUPPRIMER

/*
* On utilise une fonction pour créer notre custom post type 'Séries TV'
WARNING : Ce template concerne un CPT "Série TV", il faut modifier les champs pour lui donner les valeurs que l'on souhaite (recette, tutoriel, fiche technique, etc.)
*/
...
function wpm_custom_post_type() {
    ...
    // On enlève "editor" pour ne pas avoir le WYSIWYG de base d'un article
    ...
    // Toutes les dashicons sont ici : https://developer.wordpress.org/resource/dashicons/#email
